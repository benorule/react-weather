...
const Forecast = () => {
  ...
  return (
    <div className='hero-container'>
      <video src='https://benorule.github.io/react-weather/build/videos/video-2.mp4' autoPlay loop muted />
      ...
      <form onSubmit={getForecast}>
        ...
        <button className="field button" type="submit">Get Weather</button>
      </form>
    </div>
  )
}
